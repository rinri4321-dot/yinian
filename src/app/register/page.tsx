  ...
  return (
    <div className="page-transition mx-auto max-w-lg px-5 py-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label className="mb-1.5 block text-sm font-medium text-[var(--fg-secondary)]">你的名字</label>
          <input
            type="text"
            value={name}
      ...
      <p className="mt-6 text-center text-[13px] text-[var(--fg-subtle)]">
        已有账号？{" "}
        <Link href="/login" className="font-medium text-[var(--fg-secondary)] hover:text-[var(--fg)]">
          登录
        </Link>
      </p>
    </div>
